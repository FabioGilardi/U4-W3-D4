...
import FabioGilardi.dao.AttendancesDAO;
import FabioGilardi.dao.EventsDAO;
import FabioGilardi.dao.LocationsDAO;
import FabioGilardi.dao.PeopleDAO;
...
// --------------------------------U4-W3-D4----------------------------------------------------------
        ...
        eventsDAO.getConcertiPerGenere(ConcertType.ROCK).forEach(System.out::println);
